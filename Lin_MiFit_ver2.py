...
if __name__=='__main__':
	...
	EP_thick=np.array([3720.,3300,2940,2610,2280,2020,1770,1570,1370,1210,1050,920,800,420])
	EP_thick_err=np.array([130,110,110,105,80,75,60,55,50,45,35,35,25,20])
	#EP_thick_err=np.full(thick.shape[0],20.)

	thin=np.array([4.,5.,6.,7.,8.,9.,10.,11.,12.,16.])
	EP_thin=np.array([3650,3180,2765,2395,2060,1770,1515,1290,1085,470])
	EP_thin_err=np.full(thin.shape[0],4)
